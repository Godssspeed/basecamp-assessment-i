...
myName = "Hakeem Olajuwon" ? console.log(`My name is ${myName}`) : console.log(`My name is ${notHakeem}`);
...
age >= canDrive ? console.log(true) : console.log(false);
...
console.log(responseCreator("fefenf"));

console.log(sum(5));

console.log(greeter("Will", 25));
